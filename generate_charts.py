...
if __name__ == "__main__":
    ...
    data_dim100 = load_data("results_100_0001.csv")
    ...
    generate_scatter_err_vs_time(data_dim10, 1, "dim-100-batch1.png")
    generate_scatter_err_vs_time(data_dim100, 50, "dim-100-batch-50.png")
    generate_scatter_err_vs_time(data_dim100, 500, "dim-100-batch-500.png")
    generate_scatter_err_vs_time(data_dim100, 500, "dim-100-batch-1000.png")
